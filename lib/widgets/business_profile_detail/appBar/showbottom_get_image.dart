...
class ShowBottomGetImage {
  static final _picker = ImagePicker();
  static late BusinessImagePickProvider _pickProvider;

  static PersistentBottomSheetController<dynamic>? getShowBottomSheet(
      BuildContext context) {
    _pickProvider =
        Provider.of<BusinessImagePickProvider>(context, listen: false);
    showBottomSheet(
        context: context,
        builder: (context) {
          return Material(
  ...
  static Future getFromGalleryImage() async {
    ...
    try {
      ...
      if (pickedImage != null) {
        _pickProvider.selectImage = pickedImage.path;
        _pickProvider.imageAdd(pickedImage.path);
      } else {
