...
class FaceDeepAr extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<FaceDeepAr> {
...
*/
  List masks = [
    "none",
    "assets/aviators/aviators",
    "assets/beauty/beauty",
    "assets/hair_segmentation/hair_segmentation",
    "assets/basebeauty/look1",
    "assets/basebeauty/look2"
  ];
  List effects = [
    "none",
    "assets/fire",
